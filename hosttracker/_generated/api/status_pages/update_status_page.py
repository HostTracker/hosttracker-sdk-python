...
from ...models.status_page_patch_request import StatusPagePatchRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body: StatusPagePatchRequest | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Change a status page's title and/or settings.
     ...
     Patches the page: send title and/or any settings members - only what is sent changes, and an
    explicit null clears a clearable member. Features are named tokens; sending the array replaces the
    whole feature set. Answers the page as it now stands.

    Args:
        id (UUID):
        idempotency_key (str | Unset):
        body (StatusPagePatchRequest | Unset): The member vocabulary is closed: a member not
    ...
    Returns:
        Response[IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageView | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageView | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
