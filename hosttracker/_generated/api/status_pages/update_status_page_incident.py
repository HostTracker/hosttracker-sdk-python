...
from ...models.status_page_incident_patch_request import StatusPageIncidentPatchRequest
...
def _get_kwargs(
    ...
    incident_id: UUID,
    *,
    body: StatusPageIncidentPatchRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/statuspage/{id}/incident/{incident_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Fix a declared incident's title, kind or components; set its postmortem.
     ...
     Patches what the incident IS - title, kind, affected components - without touching its timeline, and
    sets/replaces/clears the postmortem write-up. Progress is NOT a patch: append a timeline update
    instead, and resolve by appending a resolved update.

    Args:
        id (UUID):
        incident_id (UUID):
        idempotency_key (str | Unset):
        body (StatusPageIncidentPatchRequest | Unset): The member vocabulary is closed: a member
    ...
    Returns:
        Response[IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageIncidentView | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageIncidentView | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
