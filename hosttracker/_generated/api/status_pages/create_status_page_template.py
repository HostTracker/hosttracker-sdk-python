...
from ...models.status_page_template_view import StatusPageTemplateView
from ...models.status_page_template_write_request import StatusPageTemplateWriteRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body: StatusPageTemplateWriteRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/statuspage/{id}/template".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = StatusPageTemplateView.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Save an incident template.
     ...
     Saves a preset {title, message, defaultImpact?} for future declarations. Templates have no update by
    design - save a new one and delete the old.

    Args:
        id (UUID):
        idempotency_key (str | Unset):
        body (StatusPageTemplateWriteRequest): The member vocabulary is closed: a member not
    ...
    Returns:
        Response[IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageTemplateView | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageTemplateView | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
