...
from ...models.status_page_query_request import StatusPageQueryRequest
...
def _get_kwargs(
    *,
    body: StatusPageQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listStatusPage, with the parameters in a JSON body.

     Takes exactly the parameters listStatusPage accepts on the query string, as one JSON object: a list-
    ...
    identical to what listStatusPage returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listStatusPage otherwise, since a GET can
    be cached and a POST cannot. A member this operation does not define is refused, exactly as an
    unknown query parameter is.

    Args:
        body (StatusPageQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | StatusPageListPage | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | StatusPageListPage | UnsupportedMediaType
    """
