...
from ...models.status_page_incident_page import StatusPageIncidentPage
from ...models.status_page_incident_query_request import StatusPageIncidentQueryRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body: StatusPageIncidentQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/statuspage/{id}/incident/q".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = StatusPageIncidentPage.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listStatusPageIncident, with the parameters in a JSON body.

     Takes exactly the parameters listStatusPageIncident accepts on the query string, as one JSON object:
    ...
    identical to what listStatusPageIncident returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listStatusPageIncident otherwise, since a
    ...
    Args:
        id (UUID):
        body (StatusPageIncidentQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageIncidentPage | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageIncidentPage | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
