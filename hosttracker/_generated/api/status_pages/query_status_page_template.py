...
from ...models.status_page_template_page import StatusPageTemplatePage
from ...models.status_page_template_query_request import StatusPageTemplateQueryRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body: StatusPageTemplateQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/statuspage/{id}/template/q".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = StatusPageTemplatePage.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listStatusPageTemplate, with the parameters in a JSON body.

     Takes exactly the parameters listStatusPageTemplate accepts on the query string, as one JSON object:
    ...
    identical to what listStatusPageTemplate returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listStatusPageTemplate otherwise, since a
    ...
    Args:
        id (UUID):
        body (StatusPageTemplateQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageTemplatePage | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | StatusPageTemplatePage | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
