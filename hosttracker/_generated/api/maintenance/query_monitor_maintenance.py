...
from ...models.monitor_maintenance_query_request import MonitorMaintenanceQueryRequest
...
def _get_kwargs(
    monitor_id: UUID,
    *,
    body: MonitorMaintenanceQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/{monitor_id}/maintenance/q".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 422:
        ...
        def _parse_response_422(data: object) -> UnknownExpand | UnknownField | UnknownParameter | ValidationFailed:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listMonitorMaintenance, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorMaintenance accepts on the query string, as one JSON object:
    ...
    identical to what listMonitorMaintenance returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listMonitorMaintenance otherwise, since a
    ...
    Args:
        monitor_id (UUID):
        body (MonitorMaintenanceQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MaintenancePage | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MaintenancePage | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
