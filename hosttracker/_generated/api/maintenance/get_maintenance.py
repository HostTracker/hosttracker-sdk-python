...
from ...models.get_maintenance_expand_item import GetMaintenanceExpandItem
from ...models.get_maintenance_fields_item import GetMaintenanceFieldsItem
...
def _get_kwargs(
    id: UUID,
    *,
    expand: list[GetMaintenanceExpandItem] | Unset = UNSET,
    fields: list[GetMaintenanceFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    makes the Location header a created window answers with worth following, and what makes the row safe
    to send straight back to an update. A window that does not exist and one that belongs to another
    account answer the same 404. Nothing is embedded by default: ask for expand=monitor for the
    ...
    Args:
        id (UUID):
        expand (list[GetMaintenanceExpandItem] | Unset):
        fields (list[GetMaintenanceFieldsItem] | Unset):
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MaintenanceView | MethodNotAllowed | NotFound | QuotaExceeded | UnknownExpand | UnknownField | UnknownParameter]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MaintenanceView | MethodNotAllowed | NotFound | QuotaExceeded | UnknownExpand | UnknownField | UnknownParameter
    """
