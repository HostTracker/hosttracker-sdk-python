...
from ...models.monitor_result_query_request import MonitorResultQueryRequest
...
def _get_kwargs(
    monitor_id: UUID,
    *,
    body: MonitorResultQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/{monitor_id}/result/q".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listMonitorResult, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorResult accepts on the query string, as one JSON object: a
    ...
    identical to what listMonitorResult returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listMonitorResult otherwise, since a GET
    ...
    Args:
        monitor_id (UUID):
        body (MonitorResultQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | ResultPage | ServiceUnavailable | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | ResultPage | ServiceUnavailable | UnsupportedMediaType
    """
