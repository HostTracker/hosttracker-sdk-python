...
from ...models.result_query_request import ResultQueryRequest
...
def _get_kwargs(
    *,
    body: ResultQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/result/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listResult, with the parameters in a JSON body.

     Takes exactly the parameters listResult accepts on the query string, as one JSON object: a list-
    ...
    identical to what listResult returns for the same values, and the caller needs the same scope - this
    ...
    text carrying reserved characters - and stay on listResult otherwise, since a GET can be cached and
    a POST cannot. A member this operation does not define is refused, exactly as an unknown query
    parameter is.

    Args:
        body (ResultQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | TooManyItems | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | ResultPage | ServiceUnavailable | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | TooManyItems | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | ResultPage | ServiceUnavailable | UnsupportedMediaType
    """
