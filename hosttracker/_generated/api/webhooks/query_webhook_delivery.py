...
from ...models.webhook_delivery_query_request import WebhookDeliveryQueryRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body: WebhookDeliveryQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/webhook/{id}/delivery/q".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listWebhookDelivery, with the parameters in a JSON body.

     Takes exactly the parameters listWebhookDelivery accepts on the query string, as one JSON object: a
    ...
    identical to what listWebhookDelivery returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listWebhookDelivery otherwise, since a GET
    ...
    Args:
        id (UUID):
        body (WebhookDeliveryQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownEventType | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType | WebhookDeliveryPage]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownEventType | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType | WebhookDeliveryPage
    """
