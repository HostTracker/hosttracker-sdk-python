...
from ...models.webhook_query_request import WebhookQueryRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: WebhookQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listWebhook, with the parameters in a JSON body.

     Takes exactly the parameters listWebhook accepts on the query string, as one JSON object: a list-
    ...
    identical to what listWebhook returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listWebhook otherwise, since a GET can be
    cached and a POST cannot. A member this operation does not define is refused, exactly as an unknown
    query parameter is.

    Args:
        body (WebhookQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType | WebhookPage]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType | WebhookPage
    """
