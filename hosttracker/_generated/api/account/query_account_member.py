...
from ...models.account_member_query_request import AccountMemberQueryRequest
...
def _get_kwargs(
    *,
    body: AccountMemberQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/account/member/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listAccountMember, with the parameters in a JSON body.

     Takes exactly the parameters listAccountMember accepts on the query string, as one JSON object: a
    ...
    identical to what listAccountMember returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listAccountMember otherwise, since a GET
    ...
    Args:
        body (AccountMemberQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[AccountMemberPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        AccountMemberPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
