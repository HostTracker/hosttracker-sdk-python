...
from ...models.monitor_incident_query_request import MonitorIncidentQueryRequest
...
def _get_kwargs(
    monitor_id: UUID,
    *,
    body: MonitorIncidentQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/{monitor_id}/incident/q".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listMonitorIncident, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorIncident accepts on the query string, as one JSON object: a
    ...
    identical to what listMonitorIncident returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listMonitorIncident otherwise, since a GET
    ...
    Args:
        monitor_id (UUID):
        body (MonitorIncidentQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[IncidentPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IncidentPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
