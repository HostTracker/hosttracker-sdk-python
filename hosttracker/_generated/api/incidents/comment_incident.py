...
from ...models.incident_comment_request import IncidentCommentRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/incident/{id}/comment".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Annotate an incident and get the incident back.
     ...
     Attaches a short comment to an incident and answers with the incident as it now stands, so no
    follow-up read is needed. Use it to record a cause or a resolution alongside the outage itself. Only
    the monitor's owner may comment - read access through a publicly shared monitor is not enough - and
    the write is convergent, so a retried submission changes nothing twice.
    ...
    Returns:
        Response[IdempotencyKeyConflict | IncidentView | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | IncidentView | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
