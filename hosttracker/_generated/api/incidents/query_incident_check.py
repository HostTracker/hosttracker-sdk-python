...
from ...models.incident_check_query_request import IncidentCheckQueryRequest
...
def _get_kwargs(
    id: str,
    *,
    body: IncidentCheckQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/incident/{id}/check/q".format(
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 422:
        ...
        def _parse_response_422(
            data: object,
        ) -> InvalidCursor | InvalidLimit | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listIncidentCheck, with the parameters in a JSON body.

     Takes exactly the parameters listIncidentCheck accepts on the query string, as one JSON object: a
    ...
    identical to what listIncidentCheck returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listIncidentCheck otherwise, since a GET
    ...
    Args:
        id (str):
        body (IncidentCheckQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | PackageLimit | InternalError | InvalidCursor | InvalidLimit | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | ResultPage | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | PackageLimit | InternalError | InvalidCursor | InvalidLimit | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | ResultPage | UnsupportedMediaType
    """
