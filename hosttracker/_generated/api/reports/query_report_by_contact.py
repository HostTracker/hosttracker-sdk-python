...
from ...models.report_by_contact_query_request import ReportByContactQueryRequest
...
def _get_kwargs(
    *,
    body: ReportByContactQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/report/by-contact/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listReportByContact, with the parameters in a JSON body.

     Takes exactly the parameters listReportByContact accepts on the query string, as one JSON object: a
    ...
    identical to what listReportByContact returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listReportByContact otherwise, since a GET
    ...
    Args:
        body (ReportByContactQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[ContactGroupedReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        ContactGroupedReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
