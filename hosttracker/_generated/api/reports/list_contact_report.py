...
from ...models.list_contact_report_fields_item import ListContactReportFieldsItem
...
def _get_kwargs(
    ...
    *,
    ...
    fields: list[ListContactReportFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        cursor (str | Unset):
        fields (list[ListContactReportFieldsItem] | Unset):
    ...
    Returns:
        Response[ContactReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | NotFound | QuotaExceeded | UnknownField | UnknownParameter]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ContactReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | NotFound | QuotaExceeded | UnknownField | UnknownParameter
    """
