...
from ...models.monitor_report_query_request import MonitorReportQueryRequest
from ...models.monitor_report_subscription_page import MonitorReportSubscriptionPage
...
def _get_kwargs(
    monitor_id: UUID,
    *,
    body: MonitorReportQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/{monitor_id}/report/q".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MonitorReportSubscriptionPage.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listMonitorReport, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorReport accepts on the query string, as one JSON object: a
    ...
    identical to what listMonitorReport returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listMonitorReport otherwise, since a GET
    ...
    Args:
        monitor_id (UUID):
        body (MonitorReportQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorReportSubscriptionPage | NotFound | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorReportSubscriptionPage | NotFound | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
