...
from ...models.contact_grouped_report_subscription_page import ContactGroupedReportSubscriptionPage
from ...models.insufficient_rights import InsufficientRights
from ...models.internal_error import InternalError
from ...models.invalid_token import InvalidToken
from ...models.ip_not_allowed import IpNotAllowed
from ...models.list_report_by_contact_contact_type_item import (
    ListReportByContactContactTypeItem,
)
from ...models.list_report_by_contact_fields_item import (
    ListReportByContactFieldsItem,
)
from ...models.list_report_by_contact_monitor_type_item import (
...
def _get_kwargs(
    *,
    ...
    monitor_type: list[ListReportByContactMonitorTypeItem] | Unset = UNSET,
    ...
    contact_type: list[ListReportByContactContactTypeItem] | Unset = UNSET,
    contact_confirmed: bool | Unset = UNSET,
    contact_q: str | Unset = UNSET,
    limit: int | Unset = 50,
    cursor: str | Unset = UNSET,
    fields: list[ListReportByContactFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ContactGroupedReportSubscriptionPage.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """List every report subscription on the account, grouped by contact.
     ...
     The same report wiring as listReportSubscription, grouped one element per contact with its
    subscribed monitors nested underneath. The mirror of listReportByMonitor.

    Args:
        monitor_id (list[str] | Unset):
        monitor_type (list[ListReportByContactMonitorTypeItem] | Unset):
        monitor_tag (list[str] | Unset):
        monitor_url (list[str] | Unset):
        monitor_like (bool | Unset):
        monitor_q (str | Unset):
        contact_id (list[str] | Unset):
        contact_type (list[ListReportByContactContactTypeItem] | Unset):
        contact_confirmed (bool | Unset):
        contact_q (str | Unset):
        limit (int | Unset):  Default: 50.
        cursor (str | Unset):
        fields (list[ListReportByContactFieldsItem] | Unset):
    ...
    Returns:
        Response[ContactGroupedReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed]
    """
...
def sync(
    *,
    ...
    Returns:
        ContactGroupedReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed
    """
