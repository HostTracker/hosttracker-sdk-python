...
from ...models.report_type_query_request import ReportTypeQueryRequest
...
def _get_kwargs(
    *,
    body: ReportTypeQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listReportType, with the parameters in a JSON body.

     Takes exactly the parameters listReportType accepts on the query string, as one JSON object: a list-
    ...
    identical to what listReportType returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listReportType otherwise, since a GET can
    be cached and a POST cannot. A member this operation does not define is refused, exactly as an
    unknown query parameter is.

    Args:
        body (ReportTypeQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InternalError | MalformedRequest | MethodNotAllowed | PayloadTooLarge | ReportTypePage | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InternalError | MalformedRequest | MethodNotAllowed | PayloadTooLarge | ReportTypePage | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
