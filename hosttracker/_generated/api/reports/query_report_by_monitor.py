...
from ...models.report_by_monitor_query_request import ReportByMonitorQueryRequest
...
def _get_kwargs(
    *,
    body: ReportByMonitorQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/report/by-monitor/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listReportByMonitor, with the parameters in a JSON body.

     Takes exactly the parameters listReportByMonitor accepts on the query string, as one JSON object: a
    ...
    identical to what listReportByMonitor returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listReportByMonitor otherwise, since a GET
    ...
    Args:
        body (ReportByMonitorQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorGroupedReportSubscriptionPage | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorGroupedReportSubscriptionPage | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
