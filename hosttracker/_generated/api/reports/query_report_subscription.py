...
from ...models.report_subscription_query_request import ReportSubscriptionQueryRequest
...
def _get_kwargs(
    *,
    body: ReportSubscriptionQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listReportSubscription, with the parameters in a JSON body.

     Takes exactly the parameters listReportSubscription accepts on the query string, as one JSON object:
    ...
    identical to what listReportSubscription returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listReportSubscription otherwise, since a
    ...
    Args:
        body (ReportSubscriptionQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[AccountReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        AccountReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
