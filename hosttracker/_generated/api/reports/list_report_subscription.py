...
from ...models.account_report_subscription_page import AccountReportSubscriptionPage
from ...models.insufficient_rights import InsufficientRights
from ...models.internal_error import InternalError
from ...models.invalid_token import InvalidToken
from ...models.ip_not_allowed import IpNotAllowed
from ...models.list_report_subscription_contact_type_item import (
    ListReportSubscriptionContactTypeItem,
)
from ...models.list_report_subscription_fields_item import (
    ListReportSubscriptionFieldsItem,
)
from ...models.list_report_subscription_monitor_type_item import (
...
def _get_kwargs(
    *,
    ...
    monitor_type: list[ListReportSubscriptionMonitorTypeItem] | Unset = UNSET,
    ...
    contact_type: list[ListReportSubscriptionContactTypeItem] | Unset = UNSET,
    contact_confirmed: bool | Unset = UNSET,
    contact_q: str | Unset = UNSET,
    limit: int | Unset = 50,
    cursor: str | Unset = UNSET,
    fields: list[ListReportSubscriptionFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AccountReportSubscriptionPage.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """List every report subscription on the account, flat.
     ...
     Returns every (monitor, contact) report pair the account holds as one flat list - both sides
    identified on every row, with the pair's frequency set. Narrow by the entity-prefixed filters of
    either side: monitor.id, monitor.type, monitor.tag, monitor.url (+monitor.like), monitor.q, and
    contact.id, contact.type, contact.confirmed, contact.q. The report twin of the flat alert-
    subscription list.

    Args:
        monitor_id (list[str] | Unset):
        monitor_type (list[ListReportSubscriptionMonitorTypeItem] | Unset):
        monitor_tag (list[str] | Unset):
        monitor_url (list[str] | Unset):
        monitor_like (bool | Unset):
        monitor_q (str | Unset):
        contact_id (list[str] | Unset):
        contact_type (list[ListReportSubscriptionContactTypeItem] | Unset):
        contact_confirmed (bool | Unset):
        contact_q (str | Unset):
        limit (int | Unset):  Default: 50.
        cursor (str | Unset):
        fields (list[ListReportSubscriptionFieldsItem] | Unset):
    ...
    Returns:
        Response[AccountReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed]
    """
...
def sync(
    *,
    ...
    Returns:
        AccountReportSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed
    """
