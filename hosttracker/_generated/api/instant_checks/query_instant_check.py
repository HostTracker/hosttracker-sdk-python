...
from ...models.instant_check_query_request import InstantCheckQueryRequest
...
def _get_kwargs(
    *,
    body: InstantCheckQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listInstantCheck, with the parameters in a JSON body.

     Takes exactly the parameters listInstantCheck accepts on the query string, as one JSON object: a
    ...
    identical to what listInstantCheck returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listInstantCheck otherwise, since a GET
    ...
    Args:
        body (InstantCheckQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[IcHistoryPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        IcHistoryPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
