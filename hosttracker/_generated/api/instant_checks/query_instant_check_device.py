...
from ...models.instant_check_device_query_request import InstantCheckDeviceQueryRequest
...
def _get_kwargs(
    *,
    body: InstantCheckDeviceQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listInstantCheckDevice, with the parameters in a JSON body.

     Takes exactly the parameters listInstantCheckDevice accepts on the query string, as one JSON object:
    ...
    identical to what listInstantCheckDevice returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listInstantCheckDevice otherwise, since a
    ...
    Args:
        body (InstantCheckDeviceQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[IcDevicePage | InternalError | MalformedRequest | MethodNotAllowed | PayloadTooLarge | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        IcDevicePage | InternalError | MalformedRequest | MethodNotAllowed | PayloadTooLarge | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
