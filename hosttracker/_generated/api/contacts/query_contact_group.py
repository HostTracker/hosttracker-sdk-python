...
from ...models.contact_group_query_request import ContactGroupQueryRequest
...
def _get_kwargs(
    *,
    body: ContactGroupQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listContactGroup, with the parameters in a JSON body.

     Takes exactly the parameters listContactGroup accepts on the query string, as one JSON object: a
    ...
    identical to what listContactGroup returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listContactGroup otherwise, since a GET
    ...
    Args:
        body (ContactGroupQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[ContactGroupPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        ContactGroupPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
