...
from ...models.agent_ip_query_request import AgentIpQueryRequest
...
def _get_kwargs(
    *,
    body: AgentIpQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listAgentIp, with the parameters in a JSON body.

     Takes exactly the parameters listAgentIp accepts on the query string, as one JSON object: a list-
    ...
    identical to what listAgentIp returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listAgentIp otherwise, since a GET can be
    cached and a POST cannot. A member this operation does not define is refused, exactly as an unknown
    query parameter is.

    Args:
        body (AgentIpQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[AgentIpPage | InternalError | InvalidCursor | InvalidLimit | UnknownField | UnknownParameter | ValidationFailed | MalformedRequest | MethodNotAllowed | PayloadTooLarge | RateLimited | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        AgentIpPage | InternalError | InvalidCursor | InvalidLimit | UnknownField | UnknownParameter | ValidationFailed | MalformedRequest | MethodNotAllowed | PayloadTooLarge | RateLimited | UnsupportedMediaType
    """
