...
from ...models.monitor_type_query_request import MonitorTypeQueryRequest
...
def _get_kwargs(
    *,
    body: MonitorTypeQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listMonitorType, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorType accepts on the query string, as one JSON object: a
    ...
    identical to what listMonitorType returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listMonitorType otherwise, since a GET can
    be cached and a POST cannot. A member this operation does not define is refused, exactly as an
    unknown query parameter is.

    Args:
        body (MonitorTypeQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InternalError | InvalidCursor | InvalidLimit | UnknownField | UnknownParameter | ValidationFailed | MalformedRequest | MethodNotAllowed | MonitorTypeRowPage | PayloadTooLarge | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InternalError | InvalidCursor | InvalidLimit | UnknownField | UnknownParameter | ValidationFailed | MalformedRequest | MethodNotAllowed | MonitorTypeRowPage | PayloadTooLarge | UnsupportedMediaType
    """
