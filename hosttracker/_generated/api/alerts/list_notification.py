...
from ...models.list_notification_expand_item import ListNotificationExpandItem
from ...models.list_notification_fields_item import ListNotificationFieldsItem
from ...models.list_notification_outcome_item import ListNotificationOutcomeItem
...
def _get_kwargs(
    *,
    ...
    outcome: list[ListNotificationOutcomeItem] | Unset = UNSET,
    expand: list[ListNotificationExpandItem] | Unset = UNSET,
    limit: int | Unset = 50,
    cursor: str | Unset = UNSET,
    fields: list[ListNotificationFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """List notifications delivered to the account, newest first.
     ...
     Returns a page of delivered notifications, optionally narrowed by time window, contact or delivery
    outcome, so a client can audit what was actually sent and when. Every row names the monitor that
    caused it and the number of the check behind it, which is what makes local grouping possible, and
    carries the rendered subject with a short plain-text preview of the body. Read one notification by
    id when the whole body is wanted. Ask for expand=monitor.settings (or monitor.subscription /
    monitor.lastIncident / monitor.maintenance) to embed the monitor's own blocks in the row's monitor
    object.
    ...
    Args:
        ...
        outcome (list[ListNotificationOutcomeItem] | Unset):
        expand (list[ListNotificationExpandItem] | Unset):
        limit (int | Unset):  Default: 50.
        cursor (str | Unset):
        fields (list[ListNotificationFieldsItem] | Unset):
    ...
    Returns:
        Response[AlertLogPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MethodNotAllowed | QuotaExceeded]
    """
...
def sync(
    *,
    ...
    Returns:
        AlertLogPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MethodNotAllowed | QuotaExceeded
    """
