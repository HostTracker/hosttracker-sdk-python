...
from ...models.alert_subscription_query_request import AlertSubscriptionQueryRequest
...
def _get_kwargs(
    *,
    body: AlertSubscriptionQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listAlertSubscription, with the parameters in a JSON body.

     Takes exactly the parameters listAlertSubscription accepts on the query string, as one JSON object:
    ...
    identical to what listAlertSubscription returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listAlertSubscription otherwise, since a
    ...
    Args:
        body (AlertSubscriptionQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[AccountAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        AccountAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
