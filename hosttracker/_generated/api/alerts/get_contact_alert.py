...
from ...models.get_contact_alert_fields_item import GetContactAlertFieldsItem
...
def _get_kwargs(
    ...
    monitor_id: UUID,
    *,
    fields: list[GetContactAlertFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (UUID):
        monitor_id (UUID):
        fields (list[GetContactAlertFieldsItem] | Unset):
    ...
    Returns:
        Response[ContactAlertSubscriptionView | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | NotFound | QuotaExceeded | UnknownField | UnknownParameter]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ContactAlertSubscriptionView | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | NotFound | QuotaExceeded | UnknownField | UnknownParameter
    """
