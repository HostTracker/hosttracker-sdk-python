...
from ...models.list_alert_by_monitor_contact_type_item import (
    ListAlertByMonitorContactTypeItem,
)
from ...models.list_alert_by_monitor_fields_item import (
    ListAlertByMonitorFieldsItem,
)
from ...models.list_alert_by_monitor_monitor_type_item import (
    ListAlertByMonitorMonitorTypeItem,
)
from ...models.method_not_allowed import MethodNotAllowed
from ...models.missing_scope import MissingScope
from ...models.monitor_grouped_alert_subscription_page import MonitorGroupedAlertSubscriptionPage
...
def _get_kwargs(
    *,
    ...
    monitor_type: list[ListAlertByMonitorMonitorTypeItem] | Unset = UNSET,
    ...
    contact_type: list[ListAlertByMonitorContactTypeItem] | Unset = UNSET,
    contact_confirmed: bool | Unset = UNSET,
    contact_q: str | Unset = UNSET,
    limit: int | Unset = 50,
    cursor: str | Unset = UNSET,
    fields: list[ListAlertByMonitorFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MonitorGroupedAlertSubscriptionPage.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """List every alert subscription on the account, grouped by monitor.
     ...
     The same alert wiring as listAlertSubscription, grouped one element per monitor with its subscribed
    contacts nested underneath - so each monitor's identity is carried once rather than repeated for
    every contact. Takes the same filters as the flat list; reach for it to render a monitor-first
    subscription matrix without de-duplicating the monitor rows yourself.

    Args:
        monitor_id (list[str] | Unset):
        monitor_type (list[ListAlertByMonitorMonitorTypeItem] | Unset):
        monitor_tag (list[str] | Unset):
        monitor_url (list[str] | Unset):
        monitor_like (bool | Unset):
        monitor_q (str | Unset):
        contact_id (list[str] | Unset):
        contact_type (list[ListAlertByMonitorContactTypeItem] | Unset):
        contact_confirmed (bool | Unset):
        contact_q (str | Unset):
        limit (int | Unset):  Default: 50.
        cursor (str | Unset):
        fields (list[ListAlertByMonitorFieldsItem] | Unset):
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | MonitorGroupedAlertSubscriptionPage | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | MonitorGroupedAlertSubscriptionPage | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed
    """
