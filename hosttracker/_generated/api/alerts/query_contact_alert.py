...
from ...models.contact_alert_query_request import ContactAlertQueryRequest
from ...models.contact_alert_subscription_page import ContactAlertSubscriptionPage
...
def _get_kwargs(
    id: UUID,
    *,
    body: ContactAlertQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/contact/{id}/alert/q".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ContactAlertSubscriptionPage.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listContactAlert, with the parameters in a JSON body.

     Takes exactly the parameters listContactAlert accepts on the query string, as one JSON object: a
    ...
    identical to what listContactAlert returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listContactAlert otherwise, since a GET
    ...
    Args:
        id (UUID):
        body (ContactAlertQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[ContactAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ContactAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | NotFound | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
