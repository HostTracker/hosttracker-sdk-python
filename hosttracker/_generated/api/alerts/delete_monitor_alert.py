...
from ...models.subscription_delete_receipt import SubscriptionDeleteReceipt
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SubscriptionDeleteReceipt.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | NotFound | QuotaExceeded | SubscriptionDeleteReceipt | UnknownParameter]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | NotFound | QuotaExceeded | SubscriptionDeleteReceipt | UnknownParameter
    """
