...
from ...models.account_alert_subscription_page import AccountAlertSubscriptionPage
from ...models.insufficient_rights import InsufficientRights
from ...models.internal_error import InternalError
from ...models.invalid_token import InvalidToken
from ...models.ip_not_allowed import IpNotAllowed
from ...models.list_alert_subscription_contact_type_item import (
    ListAlertSubscriptionContactTypeItem,
)
from ...models.list_alert_subscription_fields_item import (
    ListAlertSubscriptionFieldsItem,
)
from ...models.list_alert_subscription_monitor_type_item import (
...
def _get_kwargs(
    *,
    ...
    monitor_type: list[ListAlertSubscriptionMonitorTypeItem] | Unset = UNSET,
    ...
    contact_type: list[ListAlertSubscriptionContactTypeItem] | Unset = UNSET,
    contact_confirmed: bool | Unset = UNSET,
    contact_q: str | Unset = UNSET,
    limit: int | Unset = 50,
    cursor: str | Unset = UNSET,
    fields: list[ListAlertSubscriptionFieldsItem] | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AccountAlertSubscriptionPage.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """List every alert subscription on the account, flat.
     ...
     Returns every (monitor, contact) alert pair the account holds as one flat list - both sides
    identified on every row, with the pair's alert-type set. Narrow by the entity-prefixed filters of
    either side: monitor.id, monitor.type, monitor.tag, monitor.url (+monitor.like), monitor.q, and
    contact.id, contact.type, contact.confirmed, contact.q. The one read that audits the whole account's
    alert wiring; the nested per-monitor and per-contact lists answer one parent's slice.

    Args:
        monitor_id (list[str] | Unset):
        monitor_type (list[ListAlertSubscriptionMonitorTypeItem] | Unset):
        monitor_tag (list[str] | Unset):
        monitor_url (list[str] | Unset):
        monitor_like (bool | Unset):
        monitor_q (str | Unset):
        contact_id (list[str] | Unset):
        contact_type (list[ListAlertSubscriptionContactTypeItem] | Unset):
        contact_confirmed (bool | Unset):
        contact_q (str | Unset):
        limit (int | Unset):  Default: 50.
        cursor (str | Unset):
        fields (list[ListAlertSubscriptionFieldsItem] | Unset):
    ...
    Returns:
        Response[AccountAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed]
    """
...
def sync(
    *,
    ...
    Returns:
        AccountAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed
    """
