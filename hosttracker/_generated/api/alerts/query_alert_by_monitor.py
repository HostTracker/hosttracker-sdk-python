...
from ...models.alert_by_monitor_query_request import AlertByMonitorQueryRequest
...
def _get_kwargs(
    *,
    body: AlertByMonitorQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/alert/by-monitor/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listAlertByMonitor, with the parameters in a JSON body.

     Takes exactly the parameters listAlertByMonitor accepts on the query string, as one JSON object: a
    ...
    identical to what listAlertByMonitor returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listAlertByMonitor otherwise, since a GET
    ...
    Args:
        body (AlertByMonitorQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorGroupedAlertSubscriptionPage | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorGroupedAlertSubscriptionPage | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
