...
from ...models.monitor_alert_subscription_view import MonitorAlertSubscriptionView
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/monitor/{monitor_id}/alert/{contact_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MonitorAlertSubscriptionView.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Set the alert-type set for this monitor-and-contact pair.
     ...
     Idempotently sets which alert types this contact receives for this monitor. `alertTypes` is the
    EXACT desired set (at least one); use DELETE to remove the subscription. Answers with the resulting
    subscription. The contact's address is included only when the token also carries a contact read
    scope - a monitor-scoped token sees which contact it is, not how to reach it.
    ...
    Returns:
        Response[IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorAlertSubscriptionView | NotFound | PayloadTooLarge | QuotaExceeded | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorAlertSubscriptionView | NotFound | PayloadTooLarge | QuotaExceeded | UnknownEnumValue | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
