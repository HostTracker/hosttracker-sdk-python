...
from ...models.alert_by_contact_query_request import AlertByContactQueryRequest
...
def _get_kwargs(
    *,
    body: AlertByContactQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/alert/by-contact/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listAlertByContact, with the parameters in a JSON body.

     Takes exactly the parameters listAlertByContact accepts on the query string, as one JSON object: a
    ...
    identical to what listAlertByContact returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on listAlertByContact otherwise, since a GET
    ...
    Args:
        body (AlertByContactQueryRequest | Unset): The parameters, as one JSON object. A list-
    ...
    Returns:
        Response[ContactGroupedAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        ContactGroupedAlertSubscriptionPage | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
