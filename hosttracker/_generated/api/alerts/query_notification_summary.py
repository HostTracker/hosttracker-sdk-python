...
from ...models.notification_summary_query_request import NotificationSummaryQueryRequest
...
def _get_kwargs(
    *,
    body: NotificationSummaryQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/contact/notification/summary/q",
    }
...
def sync_detailed(
    *,
    ...
    """Query the same collection as getNotificationSummary, with the parameters in a JSON body.

     Takes exactly the parameters getNotificationSummary accepts on the query string, as one JSON object:
    a list-valued filter as a JSON array, everything else as a string, number or boolean, and null for a
    parameter you are not sending. An empty object reads the collection unfiltered. The answer is byte-
    identical to what getNotificationSummary returns for the same values, and the caller needs the same
    ...
    ids, free text carrying reserved characters - and stay on getNotificationSummary otherwise, since a
    ...
    Args:
        body (NotificationSummaryQueryRequest | Unset): The parameters, as one JSON object. A
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidRange | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotificationSummaryPage | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidRange | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | NotificationSummaryPage | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
