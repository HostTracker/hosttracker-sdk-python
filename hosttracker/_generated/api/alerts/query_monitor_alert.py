...
from ...models.monitor_alert_query_request import MonitorAlertQueryRequest
...
def _get_kwargs(
    monitor_id: UUID,
    *,
    body: MonitorAlertQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/{monitor_id}/alert/q".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listMonitorAlert, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorAlert accepts on the query string, as one JSON object: a
    ...
    identical to what listMonitorAlert returns for the same values, and the caller needs the same scope
    ...
    ids, free text carrying reserved characters - and stay on listMonitorAlert otherwise, since a GET
    ...
    Args:
        monitor_id (UUID):
        body (MonitorAlertQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorAlertSubscriptionPage | NotFound | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorAlertSubscriptionPage | NotFound | PayloadTooLarge | QuotaExceeded | UnknownField | UnknownParameter | ValidationFailed | UnsupportedMediaType
    """
