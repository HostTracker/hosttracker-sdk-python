...
from ...models.monitor_query_request import MonitorQueryRequest
...
def _get_kwargs(
    *,
    body: MonitorQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Query the same collection as listMonitor, with the parameters in a JSON body.

     Takes exactly the parameters listMonitor accepts on the query string, as one JSON object: a list-
    ...
    identical to what listMonitor returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listMonitor otherwise, since a GET can be
    cached and a POST cannot. A member this operation does not define is refused, exactly as an unknown
    query parameter is.

    Args:
        body (MonitorQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorPage | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidCursor | InvalidLimit | InvalidRange | UnknownEnumValue | UnknownExpand | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorPage | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
