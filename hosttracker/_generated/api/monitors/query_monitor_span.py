...
from ...models.monitor_span_query_request import MonitorSpanQueryRequest
...
def _get_kwargs(
    monitor_id: UUID,
    *,
    body: MonitorSpanQueryRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/monitor/{monitor_id}/span/q".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query the same collection as listMonitorSpan, with the parameters in a JSON body.

     Takes exactly the parameters listMonitorSpan accepts on the query string, as one JSON object: a
    ...
    identical to what listMonitorSpan returns for the same values, and the caller needs the same scope -
    ...
    ids, free text carrying reserved characters - and stay on listMonitorSpan otherwise, since a GET can
    be cached and a POST cannot. A member this operation does not define is refused, exactly as an
    unknown query parameter is.

    Args:
        monitor_id (UUID):
        body (MonitorSpanQueryRequest | Unset): The parameters, as one JSON object. A list-valued
    ...
    Returns:
        Response[InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidRange | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorSpanPage | NotFound | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidRange | UnknownField | UnknownParameter | ValidationFailed | InvalidToken | MalformedRequest | MethodNotAllowed | MonitorSpanPage | NotFound | PayloadTooLarge | QuotaExceeded | UnsupportedMediaType
    """
