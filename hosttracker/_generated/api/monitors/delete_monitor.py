...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MonitorDeleteReceipt.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    maintenance subscriptions that were cascaded away with it. Those counts exist nowhere else once the
    delete has run, which is why this returns a body rather than an empty response - the verification
    read a bodiless delete would force is exactly what the receipt removes.
    ...
    Returns:
        Response[IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | MonitorDeleteReceipt | NotFound | QuotaExceeded | UnknownParameter]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        IdempotencyKeyConflict | InsufficientRights | IpNotAllowed | MissingScope | InternalError | InvalidToken | MethodNotAllowed | MonitorDeleteReceipt | NotFound | QuotaExceeded | UnknownParameter
    """
