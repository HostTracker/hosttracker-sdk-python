...
T = TypeVar("T", bound="ContactAlertSubscriptionPage")


@_attrs_define
class ContactAlertSubscriptionPage:
    ...
    data: list[ContactAlertSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ContactAlertSubscriptionView.from_dict(data_item_data)
        ...
        contact_alert_subscription_page = cls(
            data=data,
        ...
        contact_alert_subscription_page.additional_properties = d
        return contact_alert_subscription_page
