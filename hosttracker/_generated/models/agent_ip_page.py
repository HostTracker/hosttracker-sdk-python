...
if TYPE_CHECKING:
    from ..models.agent_ip_summary_view import AgentIpSummaryView
    from ..models.agent_ip_view import AgentIpView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="AgentIpPage")
...
class AgentIpPage:
    ...
    summary: AgentIpSummaryView | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AgentIpView.from_dict(data_item_data)
        ...
        summary: AgentIpSummaryView | Unset
        if isinstance(_summary, Unset):
            summary = UNSET
        else:
            summary = AgentIpSummaryView.from_dict(_summary)
        ...
        agent_ip_page.additional_properties = d
        return agent_ip_page
