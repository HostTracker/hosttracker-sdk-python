...
T = TypeVar("T", bound="ReportTypePage")
...
class ReportTypePage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ReportTypeView.from_dict(data_item_data)
        ...
        report_type_page.additional_properties = d
        return report_type_page
