...
from ..models.monitor_settings_tran_step_hover_action import (
    MonitorSettingsTranStepHoverAction,
    check_monitor_settings_tran_step_hover_action,
)
...
T = TypeVar("T", bound="MonitorSettingsTranStepHover")


@_attrs_define
class MonitorSettingsTranStepHover:
    """Hover an element."""

    action: MonitorSettingsTranStepHoverAction
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        action = check_monitor_settings_tran_step_hover_action(d.pop("action"))
        ...
        monitor_settings_tran_step_hover = cls(
            action=action,
            name=name,
            timeout=timeout,
        ...
        return monitor_settings_tran_step_hover
