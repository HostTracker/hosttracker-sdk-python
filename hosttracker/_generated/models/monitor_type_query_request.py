...
from ..models.monitor_type_query_request_fields_item import (
    MonitorTypeQueryRequestFieldsItem,
    check_monitor_type_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MonitorTypeQueryRequest")


@_attrs_define
class MonitorTypeQueryRequest:
    ...
    fields: list[MonitorTypeQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_monitor_type_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        monitor_type_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return monitor_type_query_request
