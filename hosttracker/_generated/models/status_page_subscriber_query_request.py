...
from ..models.status_page_subscriber_query_request_fields_item import (
    StatusPageSubscriberQueryRequestFieldsItem,
    check_status_page_subscriber_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StatusPageSubscriberQueryRequest")


@_attrs_define
class StatusPageSubscriberQueryRequest:
    ...
    fields: list[StatusPageSubscriberQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_status_page_subscriber_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        status_page_subscriber_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return status_page_subscriber_query_request
