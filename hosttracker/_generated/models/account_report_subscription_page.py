...
T = TypeVar("T", bound="AccountReportSubscriptionPage")


@_attrs_define
class AccountReportSubscriptionPage:
    ...
    data: list[AccountReportSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AccountReportSubscriptionView.from_dict(data_item_data)
        ...
        account_report_subscription_page = cls(
            data=data,
        ...
        account_report_subscription_page.additional_properties = d
        return account_report_subscription_page
