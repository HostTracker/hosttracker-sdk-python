...
from ..models.report_type_query_request_fields_item import (
    ReportTypeQueryRequestFieldsItem,
    check_report_type_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReportTypeQueryRequest")


@_attrs_define
class ReportTypeQueryRequest:
    ...
    fields: list[ReportTypeQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_report_type_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        report_type_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return report_type_query_request
