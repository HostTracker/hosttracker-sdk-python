...
T = TypeVar("T", bound="ContactGroupedAlertSubscriptionView")


@_attrs_define
class ContactGroupedAlertSubscriptionView:
    """One element of the BY-CONTACT grouping (`GET /alert/by-contact`): one contact and every monitor it is subscribed to."""

    contact: ContactsContactRefView | Unset = UNSET
    """ The minimal identifying projection of a contact, as embedded in relation reads. """
    subscriptions: list[ContactAlertSubscriptionView] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _subscriptions is not UNSET:
            ...
            for subscriptions_item_data in _subscriptions:
                subscriptions_item = ContactAlertSubscriptionView.from_dict(subscriptions_item_data)

                subscriptions.append(subscriptions_item)

        contact_grouped_alert_subscription_view = cls(
            contact=contact,
            subscriptions=subscriptions,
        )

        contact_grouped_alert_subscription_view.additional_properties = d
        return contact_grouped_alert_subscription_view
