...
from ..models.contact_bulk_create_item_type import ContactBulkCreateItemType, check_contact_bulk_create_item_type
...
T = TypeVar("T", bound="ContactBulkCreateItem")


@_attrs_define
class ContactBulkCreateItem:
    """One contact to create, in the same shape POST /contact takes - including its inline subscription blocks."""
    ...
    type_: ContactBulkCreateItemType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_contact_bulk_create_item_type(d.pop("type"))
        ...
        return contact_bulk_create_item
