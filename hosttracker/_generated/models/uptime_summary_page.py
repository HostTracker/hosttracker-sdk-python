...
if TYPE_CHECKING:
    ...
    from ..models.uptime_summary_view import UptimeSummaryView


T = TypeVar("T", bound="UptimeSummaryPage")


@_attrs_define
class UptimeSummaryPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = UptimeSummaryView.from_dict(data_item_data)
        ...
        uptime_summary_page.additional_properties = d
        return uptime_summary_page
