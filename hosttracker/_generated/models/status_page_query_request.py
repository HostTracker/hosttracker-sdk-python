...
from ..models.status_page_query_request_fields_item import (
    StatusPageQueryRequestFieldsItem,
    check_status_page_query_request_fields_item,
)
from ..models.status_page_query_request_sort import StatusPageQueryRequestSort, check_status_page_query_request_sort
from ..types import UNSET, Unset

T = TypeVar("T", bound="StatusPageQueryRequest")


@_attrs_define
class StatusPageQueryRequest:
    ...
    sort: StatusPageQueryRequestSort | Unset = UNSET
    """ `created` | `title` | `slug`, optionally suffixed `:asc`/`:desc`. """
    limit: int | Unset = 50
    """ Rows to return. """
    cursor: str | Unset = UNSET
    """ Opaque cursor from a previous response's `nextCursor`. Absent ⇒ first page. """
    fields: list[StatusPageQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sort: StatusPageQueryRequestSort | Unset
        if isinstance(_sort, Unset):
            sort = UNSET
        else:
            sort = check_status_page_query_request_sort(_sort)
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_status_page_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        status_page_query_request = cls(
            sort=sort,
            limit=limit,
            cursor=cursor,
            fields=fields,
        ...
        return status_page_query_request
