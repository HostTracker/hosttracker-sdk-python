...
if TYPE_CHECKING:
    from ..models.alert_log_view import AlertLogView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="AlertLogPage")
...
class AlertLogPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AlertLogView.from_dict(data_item_data)
        ...
        alert_log_page.additional_properties = d
        return alert_log_page
