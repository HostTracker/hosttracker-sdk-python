...
if TYPE_CHECKING:
    from ..models.ic_history_view import IcHistoryView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="IcHistoryPage")
...
class IcHistoryPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = IcHistoryView.from_dict(data_item_data)
        ...
        ic_history_page.additional_properties = d
        return ic_history_page
