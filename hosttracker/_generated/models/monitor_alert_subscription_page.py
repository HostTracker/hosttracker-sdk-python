...
T = TypeVar("T", bound="MonitorAlertSubscriptionPage")


@_attrs_define
class MonitorAlertSubscriptionPage:
    ...
    data: list[MonitorAlertSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitorAlertSubscriptionView.from_dict(data_item_data)
        ...
        monitor_alert_subscription_page = cls(
            data=data,
        ...
        monitor_alert_subscription_page.additional_properties = d
        return monitor_alert_subscription_page
