...
from ..models.contact_notification_query_request_expand_item import (
    ContactNotificationQueryRequestExpandItem,
    check_contact_notification_query_request_expand_item,
)
from ..models.contact_notification_query_request_fields_item import (
    ContactNotificationQueryRequestFieldsItem,
    check_contact_notification_query_request_fields_item,
)
from ..models.contact_notification_query_request_outcome_item import (
    ContactNotificationQueryRequestOutcomeItem,
    check_contact_notification_query_request_outcome_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactNotificationQueryRequest")


@_attrs_define
class ContactNotificationQueryRequest:
    ...
    outcome: list[ContactNotificationQueryRequestOutcomeItem] | Unset = UNSET
    """ Which delivery outcomes to include. """
    expand: list[ContactNotificationQueryRequestExpandItem] | Unset = UNSET
    ...
    fields: list[ContactNotificationQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _outcome is not UNSET:
            ...
            for outcome_item_data in _outcome:
                outcome_item = check_contact_notification_query_request_outcome_item(outcome_item_data)
        ...
        if _expand is not UNSET:
            ...
            for expand_item_data in _expand:
                expand_item = check_contact_notification_query_request_expand_item(expand_item_data)
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_contact_notification_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        contact_notification_query_request = cls(
            from_=from_,
            to=to,
            outcome=outcome,
            expand=expand,
        ...
        return contact_notification_query_request
