...
if TYPE_CHECKING:
    from ..models.contact_page_summary import ContactPageSummary
    from ..models.contact_view import ContactView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="ContactPage")
...
class ContactPage:
    ...
    summary: ContactPageSummary | Unset = UNSET
    """ Account-wide contact counts, returned in the envelope when `expand=summary` asks for them. Counts the whole
    account, not the page. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ContactView.from_dict(data_item_data)
        ...
        summary: ContactPageSummary | Unset
        if isinstance(_summary, Unset):
            summary = UNSET
        else:
            summary = ContactPageSummary.from_dict(_summary)
        ...
        contact_page.additional_properties = d
        return contact_page
