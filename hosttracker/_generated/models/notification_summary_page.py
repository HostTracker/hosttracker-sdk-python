...
if TYPE_CHECKING:
    from ..models.notification_summary_view import NotificationSummaryView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="NotificationSummaryPage")


@_attrs_define
class NotificationSummaryPage:
    ...
    data: list[NotificationSummaryView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = NotificationSummaryView.from_dict(data_item_data)
        ...
        notification_summary_page.additional_properties = d
        return notification_summary_page
