...
T = TypeVar("T", bound="StatusPageSubscriberPage")


@_attrs_define
class StatusPageSubscriberPage:
    ...
    data: list[StatusPageSubscriberView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = StatusPageSubscriberView.from_dict(data_item_data)
        ...
        status_page_subscriber_page = cls(
            data=data,
        ...
        status_page_subscriber_page.additional_properties = d
        return status_page_subscriber_page
