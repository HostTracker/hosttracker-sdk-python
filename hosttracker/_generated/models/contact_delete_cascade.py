...
T = TypeVar("T", bound="ContactDeleteCascade")


@_attrs_define
class ContactDeleteCascade:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_delete_cascade = cls(
            alert_subscriptions=alert_subscriptions,
            report_subscriptions=report_subscriptions,
        )

        contact_delete_cascade.additional_properties = d
        return contact_delete_cascade
