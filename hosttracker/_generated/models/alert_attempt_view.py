...
T = TypeVar("T", bound="AlertAttemptView")


@_attrs_define
class AlertAttemptView:
    """One recorded delivery attempt."""

    at: int
    """ Unix seconds. """
    outcome: None | str | Unset = UNSET
    """ How the attempt ended, in the published vocabulary (`sent`, `blocked`, `sendFailed`, …). """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_attempt_view.additional_properties = d
        return alert_attempt_view
