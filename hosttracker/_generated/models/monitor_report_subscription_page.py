...
T = TypeVar("T", bound="MonitorReportSubscriptionPage")


@_attrs_define
class MonitorReportSubscriptionPage:
    ...
    data: list[MonitorReportSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitorReportSubscriptionView.from_dict(data_item_data)
        ...
        monitor_report_subscription_page = cls(
            data=data,
        ...
        monitor_report_subscription_page.additional_properties = d
        return monitor_report_subscription_page
