...
if TYPE_CHECKING:
    from ..models.agent_pool_summary_view import AgentPoolSummaryView
    from ..models.agent_pool_view import AgentPoolView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="AgentPoolPage")
...
class AgentPoolPage:
    ...
    summary: AgentPoolSummaryView | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AgentPoolView.from_dict(data_item_data)
        ...
        summary: AgentPoolSummaryView | Unset
        if isinstance(_summary, Unset):
            summary = UNSET
        else:
            summary = AgentPoolSummaryView.from_dict(_summary)
        ...
        agent_pool_page.additional_properties = d
        return agent_pool_page
