...
T = TypeVar("T", bound="IpNotAllowedError")


@_attrs_define
class IpNotAllowedError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_not_allowed_error = cls(
            pointer=pointer,
            client_ip=client_ip,
        )

        ip_not_allowed_error.additional_properties = d
        return ip_not_allowed_error
