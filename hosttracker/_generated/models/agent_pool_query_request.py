...
from ..models.agent_pool_query_request_fields_item import (
    AgentPoolQueryRequestFieldsItem,
    check_agent_pool_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AgentPoolQueryRequest")


@_attrs_define
class AgentPoolQueryRequest:
    ...
    fields: list[AgentPoolQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_agent_pool_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        agent_pool_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return agent_pool_query_request
