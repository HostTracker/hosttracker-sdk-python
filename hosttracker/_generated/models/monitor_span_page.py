...
T = TypeVar("T", bound="MonitorSpanPage")


@_attrs_define
class MonitorSpanPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitorSpanView.from_dict(data_item_data)
        ...
        monitor_span_page.additional_properties = d
        return monitor_span_page
