...
from ..models.instant_check_type_query_request_fields_item import (
    InstantCheckTypeQueryRequestFieldsItem,
    check_instant_check_type_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="InstantCheckTypeQueryRequest")


@_attrs_define
class InstantCheckTypeQueryRequest:
    ...
    fields: list[InstantCheckTypeQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_instant_check_type_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        instant_check_type_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return instant_check_type_query_request
