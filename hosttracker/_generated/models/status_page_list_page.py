...
if TYPE_CHECKING:
    ...
    from ..models.status_page_list_view import StatusPageListView


T = TypeVar("T", bound="StatusPageListPage")


@_attrs_define
class StatusPageListPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = StatusPageListView.from_dict(data_item_data)
        ...
        status_page_list_page.additional_properties = d
        return status_page_list_page
