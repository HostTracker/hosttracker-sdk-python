...
T = TypeVar("T", bound="ContactReportSubscriptionPage")


@_attrs_define
class ContactReportSubscriptionPage:
    ...
    data: list[ContactReportSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ContactReportSubscriptionView.from_dict(data_item_data)
        ...
        contact_report_subscription_page = cls(
            data=data,
        ...
        contact_report_subscription_page.additional_properties = d
        return contact_report_subscription_page
