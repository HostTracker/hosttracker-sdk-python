...
if TYPE_CHECKING:
    from ..models.job_list_item_view import JobListItemView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="JobListItemPage")


@_attrs_define
class JobListItemPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = JobListItemView.from_dict(data_item_data)
        ...
        job_list_item_page.additional_properties = d
        return job_list_item_page
