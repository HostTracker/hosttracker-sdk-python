...
if TYPE_CHECKING:
    from ..models.contact_grouped_alert_subscription_view import ContactGroupedAlertSubscriptionView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="ContactGroupedAlertSubscriptionPage")


@_attrs_define
class ContactGroupedAlertSubscriptionPage:
    ...
    data: list[ContactGroupedAlertSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ContactGroupedAlertSubscriptionView.from_dict(data_item_data)
        ...
        contact_grouped_alert_subscription_page = cls(
            data=data,
        ...
        contact_grouped_alert_subscription_page.additional_properties = d
        return contact_grouped_alert_subscription_page
