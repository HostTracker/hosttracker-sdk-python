...
from ..models.contact_alert_query_request_fields_item import (
    ContactAlertQueryRequestFieldsItem,
    check_contact_alert_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactAlertQueryRequest")


@_attrs_define
class ContactAlertQueryRequest:
    ...
    fields: list[ContactAlertQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_contact_alert_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        contact_alert_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return contact_alert_query_request
