...
from ..models.monitor_report_query_request_fields_item import (
    MonitorReportQueryRequestFieldsItem,
    check_monitor_report_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MonitorReportQueryRequest")


@_attrs_define
class MonitorReportQueryRequest:
    ...
    fields: list[MonitorReportQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_monitor_report_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        monitor_report_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return monitor_report_query_request
