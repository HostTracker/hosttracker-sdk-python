...
T = TypeVar("T", bound="MonitorTypeRowPage")


@_attrs_define
class MonitorTypeRowPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitorTypeRow.from_dict(data_item_data)
        ...
        monitor_type_row_page.additional_properties = d
        return monitor_type_row_page
