...
from ..models.contact_write_request_type import ContactWriteRequestType, check_contact_write_request_type
...
T = TypeVar("T", bound="ContactWriteRequest")


@_attrs_define
class ContactWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_contact_write_request_type(d.pop("type"))
