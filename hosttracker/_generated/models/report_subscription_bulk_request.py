...
if TYPE_CHECKING:
    from ..models.report_subscription_bulk_item import ReportSubscriptionBulkItem


T = TypeVar("T", bound="ReportSubscriptionBulkRequest")


@_attrs_define
class ReportSubscriptionBulkRequest:
    ...
    create: list[ReportSubscriptionBulkItem] | Unset = UNSET
    """ The schedules to add. """
    delete: list[ReportSubscriptionBulkItem] | Unset = UNSET
    """ The schedules to remove. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _create is not UNSET:
            ...
            for create_item_data in _create:
                create_item = ReportSubscriptionBulkItem.from_dict(create_item_data)
        ...
        if _delete is not UNSET:
            ...
            for delete_item_data in _delete:
                delete_item = ReportSubscriptionBulkItem.from_dict(delete_item_data)

                delete.append(delete_item)

        report_subscription_bulk_request = cls(
        ...
        return report_subscription_bulk_request
