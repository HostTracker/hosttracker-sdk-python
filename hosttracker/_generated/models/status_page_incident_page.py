...
T = TypeVar("T", bound="StatusPageIncidentPage")


@_attrs_define
class StatusPageIncidentPage:
    ...
    data: list[StatusPageIncidentView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = StatusPageIncidentView.from_dict(data_item_data)
        ...
        status_page_incident_page.additional_properties = d
        return status_page_incident_page
