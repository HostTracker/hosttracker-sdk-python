...
from ..models.contact_report_query_request_fields_item import (
    ContactReportQueryRequestFieldsItem,
    check_contact_report_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactReportQueryRequest")


@_attrs_define
class ContactReportQueryRequest:
    ...
    fields: list[ContactReportQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_contact_report_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        contact_report_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return contact_report_query_request
