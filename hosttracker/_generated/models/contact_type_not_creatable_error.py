...
T = TypeVar("T", bound="ContactTypeNotCreatableError")


@_attrs_define
class ContactTypeNotCreatableError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_type_not_creatable_error = cls(
            pointer=pointer,
            type_=type_,
            successor=successor,
            allowed=allowed,
        ...
        contact_type_not_creatable_error.additional_properties = d
        return contact_type_not_creatable_error
