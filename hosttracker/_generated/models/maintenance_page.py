...
T = TypeVar("T", bound="MaintenancePage")
...
class MaintenancePage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MaintenanceView.from_dict(data_item_data)
        ...
        maintenance_page.additional_properties = d
