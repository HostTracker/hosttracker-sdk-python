...
T = TypeVar("T", bound="StatusPageTemplatePage")


@_attrs_define
class StatusPageTemplatePage:
    ...
    data: list[StatusPageTemplateView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = StatusPageTemplateView.from_dict(data_item_data)
        ...
        status_page_template_page.additional_properties = d
        return status_page_template_page
