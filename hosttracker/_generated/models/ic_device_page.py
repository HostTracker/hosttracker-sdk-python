...
if TYPE_CHECKING:
    from ..models.ic_device_view import IcDeviceView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="IcDevicePage")
...
class IcDevicePage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = IcDeviceView.from_dict(data_item_data)
        ...
        ic_device_page.additional_properties = d
        return ic_device_page
