...
from ..models.account_member_query_request_fields_item import (
    AccountMemberQueryRequestFieldsItem,
    check_account_member_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AccountMemberQueryRequest")


@_attrs_define
class AccountMemberQueryRequest:
    ...
    fields: list[AccountMemberQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_account_member_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        account_member_query_request = cls(
            limit=limit,
            cursor=cursor,
            fields=fields,
        )

        return account_member_query_request
