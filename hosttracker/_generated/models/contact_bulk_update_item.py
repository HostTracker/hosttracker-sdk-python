...
from ..models.contact_bulk_update_item_type import ContactBulkUpdateItemType, check_contact_bulk_update_item_type
...
T = TypeVar("T", bound="ContactBulkUpdateItem")


@_attrs_define
class ContactBulkUpdateItem:
    """One contact to change: its `id`, plus the members to change in the same shape PATCH /contact/{id} takes. Members it
    omits are left alone.

    """

    id: UUID
    """ Which contact to change. """
    ...
    type_: ContactBulkUpdateItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: ContactBulkUpdateItemType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = check_contact_bulk_update_item_type(_type_)

        contact_bulk_update_item = cls(
            id=id,
        ...
        return contact_bulk_update_item
