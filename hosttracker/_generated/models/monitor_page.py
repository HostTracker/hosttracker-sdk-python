...
if TYPE_CHECKING:
    from ..models.monitor_summary_view import MonitorSummaryView
    from ..models.monitor_view import MonitorView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="MonitorPage")
...
class MonitorPage:
    ...
    summary: MonitorSummaryView | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary: MonitorSummaryView | Unset
        if isinstance(_summary, Unset):
            summary = UNSET
        else:
            summary = MonitorSummaryView.from_dict(_summary)
        ...
        monitor_page.additional_properties = d
        return monitor_page
