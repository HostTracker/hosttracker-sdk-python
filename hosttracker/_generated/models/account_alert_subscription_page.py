...
T = TypeVar("T", bound="AccountAlertSubscriptionPage")


@_attrs_define
class AccountAlertSubscriptionPage:
    ...
    data: list[AccountAlertSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AccountAlertSubscriptionView.from_dict(data_item_data)
        ...
        account_alert_subscription_page = cls(
            data=data,
        ...
        account_alert_subscription_page.additional_properties = d
        return account_alert_subscription_page
