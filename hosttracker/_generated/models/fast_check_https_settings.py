...
from ..models.fast_check_https_settings_auth_schema import (
    FastCheckHttpsSettingsAuthSchema,
    check_fast_check_https_settings_auth_schema,
)
from ..models.fast_check_https_settings_keyword_mode import (
    FastCheckHttpsSettingsKeywordMode,
    check_fast_check_https_settings_keyword_mode,
)
from ..models.fast_check_https_settings_method import (
    FastCheckHttpsSettingsMethod,
    check_fast_check_https_settings_method,
)
from ..models.fast_check_https_settings_preset import (
    FastCheckHttpsSettingsPreset,
    check_fast_check_https_settings_preset,
)
...
T = TypeVar("T", bound="FastCheckHttpsSettings")


@_attrs_define
class FastCheckHttpsSettings:
    """Simulates a real visitor downloading the page: collects uptime statistics and alerts on trouble. Three of every four
    monitors are this type, and it is the host of all four attach faces.

    """

    method: FastCheckHttpsSettingsMethod | Unset = "G"
    ...
    characters. """
    keyword_mode: FastCheckHttpsSettingsKeywordMode | Unset = "PresentAny"
    ...
    auth_schema: FastCheckHttpsSettingsAuthSchema | Unset = UNSET
    ...
    rows, not both. """
    preset: FastCheckHttpsSettingsPreset | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method: FastCheckHttpsSettingsMethod | Unset
        if isinstance(_method, Unset):
            method = UNSET
        else:
            method = check_fast_check_https_settings_method(_method)

        keywords = d.pop("keywords", UNSET)

        _keyword_mode = d.pop("keywordMode", UNSET)
        keyword_mode: FastCheckHttpsSettingsKeywordMode | Unset
        if isinstance(_keyword_mode, Unset):
            keyword_mode = UNSET
        else:
            keyword_mode = check_fast_check_https_settings_keyword_mode(_keyword_mode)
        ...
        auth_schema: FastCheckHttpsSettingsAuthSchema | Unset
        if isinstance(_auth_schema, Unset):
            auth_schema = UNSET
        else:
            auth_schema = check_fast_check_https_settings_auth_schema(_auth_schema)
        ...
        preset: FastCheckHttpsSettingsPreset | Unset
        if isinstance(_preset, Unset):
            preset = UNSET
        else:
            preset = check_fast_check_https_settings_preset(_preset)
        ...
        return fast_check_https_settings
