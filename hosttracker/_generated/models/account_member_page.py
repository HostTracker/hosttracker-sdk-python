...
if TYPE_CHECKING:
    from ..models.account_member_view import AccountMemberView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="AccountMemberPage")
...
class AccountMemberPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AccountMemberView.from_dict(data_item_data)
        ...
        account_member_page.additional_properties = d
        return account_member_page
