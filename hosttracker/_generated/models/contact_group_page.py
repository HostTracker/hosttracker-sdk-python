...
T = TypeVar("T", bound="ContactGroupPage")


@_attrs_define
class ContactGroupPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ContactGroupView.from_dict(data_item_data)
        ...
        contact_group_page.additional_properties = d
        return contact_group_page
