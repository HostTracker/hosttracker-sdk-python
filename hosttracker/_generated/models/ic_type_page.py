...
if TYPE_CHECKING:
    from ..models.ic_type_view import IcTypeView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="IcTypePage")
...
class IcTypePage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = IcTypeView.from_dict(data_item_data)
        ...
        ic_type_page.additional_properties = d
        return ic_type_page
