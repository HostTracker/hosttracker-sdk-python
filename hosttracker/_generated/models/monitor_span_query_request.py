...
from ..models.monitor_span_query_request_fields_item import (
    MonitorSpanQueryRequestFieldsItem,
    check_monitor_span_query_request_fields_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MonitorSpanQueryRequest")


@_attrs_define
class MonitorSpanQueryRequest:
    ...
    fields: list[MonitorSpanQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_monitor_span_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        monitor_span_query_request = cls(
            from_=from_,
            to=to,
            limit=limit,
            cursor=cursor,
        ...
        return monitor_span_query_request
