...
if TYPE_CHECKING:
    from ..models.monitor_grouped_report_subscription_view import MonitorGroupedReportSubscriptionView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="MonitorGroupedReportSubscriptionPage")


@_attrs_define
class MonitorGroupedReportSubscriptionPage:
    ...
    data: list[MonitorGroupedReportSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitorGroupedReportSubscriptionView.from_dict(data_item_data)
        ...
        monitor_grouped_report_subscription_page = cls(
            data=data,
        ...
        monitor_grouped_report_subscription_page.additional_properties = d
        return monitor_grouped_report_subscription_page
