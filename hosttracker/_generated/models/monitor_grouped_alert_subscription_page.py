...
if TYPE_CHECKING:
    from ..models.monitor_grouped_alert_subscription_view import MonitorGroupedAlertSubscriptionView
    from ..models.page_count import PageCount


T = TypeVar("T", bound="MonitorGroupedAlertSubscriptionPage")


@_attrs_define
class MonitorGroupedAlertSubscriptionPage:
    ...
    data: list[MonitorGroupedAlertSubscriptionView]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitorGroupedAlertSubscriptionView.from_dict(data_item_data)
        ...
        monitor_grouped_alert_subscription_page = cls(
            data=data,
        ...
        monitor_grouped_alert_subscription_page.additional_properties = d
        return monitor_grouped_alert_subscription_page
