...
T = TypeVar("T", bound="JobNotCancellableError")
...
class JobNotCancellableError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_not_cancellable_error = cls(
            pointer=pointer,
            state=state,
        )

        job_not_cancellable_error.additional_properties = d
        return job_not_cancellable_error
