...
from ..models.report_by_monitor_query_request_contact_type_item import (
    ReportByMonitorQueryRequestContactTypeItem,
    check_report_by_monitor_query_request_contact_type_item,
)
from ..models.report_by_monitor_query_request_fields_item import (
    ReportByMonitorQueryRequestFieldsItem,
    check_report_by_monitor_query_request_fields_item,
)
from ..models.report_by_monitor_query_request_monitor_type_item import (
    ReportByMonitorQueryRequestMonitorTypeItem,
    check_report_by_monitor_query_request_monitor_type_item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReportByMonitorQueryRequest")


@_attrs_define
class ReportByMonitorQueryRequest:
    ...
    monitor_type: list[ReportByMonitorQueryRequestMonitorTypeItem] | Unset = UNSET
    """ See this operation's description for how this parameter narrows the result. """
    ...
    """ See this operation's description for how this parameter narrows the result. """
    contact_type: list[ReportByMonitorQueryRequestContactTypeItem] | Unset = UNSET
    """ See this operation's description for how this parameter narrows the result. """
    ...
    fields: list[ReportByMonitorQueryRequestFieldsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _monitor_type is not UNSET:
            ...
            for monitor_type_item_data in _monitor_type:
                monitor_type_item = check_report_by_monitor_query_request_monitor_type_item(monitor_type_item_data)
        ...
        if _contact_type is not UNSET:
            ...
            for contact_type_item_data in _contact_type:
                contact_type_item = check_report_by_monitor_query_request_contact_type_item(contact_type_item_data)
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = check_report_by_monitor_query_request_fields_item(fields_item_data)

                fields.append(fields_item)

        report_by_monitor_query_request = cls(
        ...
        return report_by_monitor_query_request
